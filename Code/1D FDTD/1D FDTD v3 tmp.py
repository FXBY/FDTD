...
material_name = 'Strong dielectric (n = 10)' 
...
def g(t:float)->float: 
    ...
    #return 0.5*np.sin(2*np.pi*t/25)
...
fig.suptitle('1D FDTD simulation. Number of cells: '+str(N)
                                  + ', Time steps: '+str(T)
                                  + ', Material: '+material_name) 
...
#plt.show()
# ani.save('Strong dielectric.mp4', fps=25)